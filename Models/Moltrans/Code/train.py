...
def get_task(task_name):
    ...
    for i in range(5):
        for split in splits:
            if task_name.lower() == ('bindingdb_' + split.lower() + '_seed' + str(i)) :
                return './Data/BindingDB/' + split + '/seed' + str(i)
            elif task_name.lower() == ('biosnap_' + split.lower() + '_seed' + str(i)) :
                return './Data/BIOSNAP/' + split + '/seed' + str(i)
            elif task_name.lower() == ('davis_' + split.lower() + '_seed' + str(i)) :
                return './Data/Davis/' + split + '/seed' + str(i)
            elif task_name.lower() == ('drugbank_' + split.lower() + '_seed' + str(i)) :
                return './Data/DrugBank/' + split + '/seed' + str(i)
            elif task_name.lower() == ('yamanishi_e_' + split.lower() + '_seed' + str(i)) :
                return './Data/Yamanishi_e_/' + split + '/seed' + str(i)
            elif task_name.lower() == ('yamanishi_gpcr_' + split.lower() + '_seed' + str(i)) :
                return './Data/Yamanishi_gpcr/' + split + '/seed' + str(i)
            elif task_name.lower() == ('yamanishi_ic_' + split.lower() + '_seed' + str(i)) :
                return './Data/Yamanishi_ic/' + split + '/seed' + str(i)
            elif task_name.lower() == ('yamanishi_nr_' + split.lower() + '_seed' + str(i)) :
                return './Data/Yamanishi_nr/' + split + '/seed' + str(i)
