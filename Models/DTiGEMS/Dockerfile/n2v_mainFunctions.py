...
def parse_args():
    ...
    parser.add_argument('--input', nargs='?', default='recieve from the code', help='Input graph path')

    parser.add_argument('--output', nargs='?', default='output.txt', help='Embeddings path')

    
    parser.add_argument('--dimensions', type=int, default=32, help='Number of dimensions. Default is 128.')

    parser.add_argument('--walk-length', type=int, default=50, help='Length of walk per source. Default is 80.')
    ...
    parser.add_argument('--workers', type=int, default=50, help='Number of parallel workers. Default is 8.')

    parser.add_argument('--p', type=float, default=0.25, help='Return hyperparameter. Default is 1.')

    parser.add_argument('--q', type=float, default=2, help='Inout hyperparameter. Default is 1.')

    parser.add_argument('--weighted', dest='weighted', action='store_true', help='Boolean. Default is unweighted.')
