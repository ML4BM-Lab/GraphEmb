...
def load_datasets():
	...
	DrugTargetF = "/Drug-Target-Interaction-Prediciton-Method/DTIs_node2vec/Input/Custom/admat_dgc.txt"
	DrugTarget = np.genfromtxt(DrugTargetF, delimiter='\t',dtype=str)

	# read all files of similarties
	Tsim_files  = '/Drug-Target-Interaction-Prediciton-Method/DTIs_node2vec/Input/Custom/Tsim/allTsim_files.txt'
	Dsim_files  = '/Drug-Target-Interaction-Prediciton-Method/DTIs_node2vec/Input/Custom/Dsim/allDsim_files.txt'
	...
	with open('/Drug-Target-Interaction-Prediciton-Method/DTIs_node2vec/Input/Custom/DTI.txt','r') as f:
		for lines in f:
			line = lines.split()
