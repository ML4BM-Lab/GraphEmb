...
def get_list_drug_w_smiles(drug_entry):
	'''
...
def main():
	...
	list_of_drug_nodes = get_drug_nodes(file_path_drugs)
...
#############################################
## Call Drug Similarity & Protein Similarity here
##
