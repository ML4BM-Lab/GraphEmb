...
# only change for this copy from drugbank is the DTI file load
'''
logging.basicConfig()
...
def main():
	...
	# already changed here for biosnap
	DTI = pd.read_csv(os.path.join(wdir, '../../../../Data/BIOSNAP/ChG-Miner_miner-chem-gene/ChG-Miner_miner-chem-gene.tsv'), sep="\t", comment="#", header=None) 
