...
from decagon.deep.optimizer_splits import DecagonOptimizer # modified script
from decagon.deep.model import DecagonModel
from decagon.deep.minibatch_splits import EdgeMinibatchIterator # modified script
...
if DATABASE in luolike:
    ...
    n_epochs, batchsize = 10, 92 # 10, test with 92
else:
    ...
    for fold in range(0,10): # each seed 1 fold, our seed is each repetition
        ...
        for epoch in range(FLAGS.epochs):
            ...
            #for itr in range(1000):
                ...
                if itr > 1000: 
                    print('Reached maximum number of iterations (max.iter: 1000)')
                    break
                #
                itr += 1
